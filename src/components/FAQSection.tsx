...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Oui, plusieurs commerces pratiques sont disponibles : Api - Super supérette de Vicq sur Océan (17 Bis Rue de la Mairie, 50330 Vicq-sur-Mer) ouverte 7j/7 avec 700 produits du quotidien, fruits & légumes, produits locaux et frais. Également le Market Saint-Pierre-L'église (rue Des Pavillons, 02 33 54 67 17) ouvert jusqu'à 19h30. Pour plus de choix, Cherbourg se trouve à 15 minutes en voiture."
    },
    {
